          ...
          <div className="space-y-4 text-left">
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                <User size={13} className="text-indigo-500" /> HỌ VÀ TÊN HỌC SINH <span className="text-red-500">*</span>
              </label>
              <div className="relative">
                <input
                  id="student-name"
                  type="text"
                  className="input input-bordered w-full bg-slate-50 border-slate-200 focus:border-indigo-500 focus:bg-white text-sm h-11 pl-9 rounded-xl font-medium"
            ...
            <div>
              <label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                <Users size={13} className="text-indigo-500" /> LỚP HỌC <span className="text-red-500">*</span>
              </label>
              <div className="relative">
                <input
                  id="student-class"
            ...
            <button
              id="start-test-btn"
              className="btn w-full bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white border-none h-12 text-sm font-bold rounded-xl shadow-lg shadow-indigo-500/30 transition-all duration-200 gap-2 mt-2"
              onClick={handleStart}
            >
