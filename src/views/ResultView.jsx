        ...
        <div className="bg-white/85 backdrop-blur-2xl rounded-3xl p-8 shadow-2xl border border-white/80 text-center relative overflow-hidden">
          ...
          <div className="space-y-2.5">
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                className="btn bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white border-none rounded-xl text-xs font-bold py-3 gap-1.5 shadow-md shadow-orange-500/25 cursor-pointer"
                onClick={handleRetry}
              >
